...
import (
	...
	tutorialsv1 "github.com/luuthanhminh/k8s-operator-nginx/api/v1"
)
...
//+kubebuilder:rbac:groups=tutorials.minhlt,resources=ovhnginxes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tutorials.minhlt,resources=ovhnginxes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tutorials.minhlt,resources=ovhnginxes/finalizers,verbs=update
